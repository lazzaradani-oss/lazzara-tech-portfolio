...
const ProjectCard = ({ title, problem, solution, value, tags, demoLink, technicalDeepDive, promptStrategy, index = 0 }) => {
  ...
  return (
    <motion.div
      ...
      className="relative group bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl transition-all duration-300"
    >
      <div className="p-6 rounded-2xl bg-gradient-to-br from-black/40 to-black/20 border border-white/20 shadow-lg">
        ...
        <div className="p-4 rounded-xl bg-black/20 border border-white/10 shadow-inner">
